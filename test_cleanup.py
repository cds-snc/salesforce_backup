...
def test_filter_out_sobjects_removes_objs():
    sobjs = ["Foo", "Bar", "Scorecard", "ScorecardAssociation", "ScorecardMetric", "UserExternalCredential", "WebCartDocument"]
    assert c.filter_out_sobjects(sobjs) == ["Foo", "Bar"]

def test_filter_out_sobjects_deep_copies():
    sobjs = ["Foo", "Bar", "Scorecard", "ScorecardAssociation", "ScorecardMetric", "UserExternalCredential", "WebCartDocument"]
    c.filter_out_sobjects(sobjs)
    assert ["Foo", "Bar", "Scorecard", "ScorecardAssociation", "ScorecardMetric", "UserExternalCredential", "WebCartDocument"] == sobjs
